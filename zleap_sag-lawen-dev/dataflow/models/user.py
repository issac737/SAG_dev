...
class UserPreferences(DataFlowBaseModel):
    """用户偏好设置"""
...
class User(DataFlowBaseModel, MetadataMixin, TimestampMixin):
    """用户模型"""
...
class UserCreate(DataFlowBaseModel):
    """创建用户请求"""
...
class UserUpdate(DataFlowBaseModel):
    """更新用户请求"""
