...
from dataflow.api.schemas.document import DocumentResponse, DocumentUploadResponse
from dataflow.db.models import Article, ArticleSection, SourceEvent, Task
...
class DocumentService:
    ...
    async def process_document_async(
        ...
        try:
            ...
            # 4. 统一使用 DataFlowEngine 执行 Load + Extract
            from dataflow import DataFlowEngine, ExtractBaseConfig, DocumentLoadConfig
    ...
    async def get_document_events(self, article_id: str):
        ...
        from dataflow.db.models import EventEntity, ArticleSection
