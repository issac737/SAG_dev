...
from dataflow.api.schemas.entity import EntityTypeResponse
from dataflow.db.models import EntityType, SourceConfig
...
class EntityTypeService:
    ...
    async def create_article_entity_type(
        ...
        from dataflow.db.models import Article
        result = await self.db.execute(
