...
class ResearcherAgent(BaseAgent):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        # 加载 researcher.json 完整配置
        prompt_manager = get_prompt_manager()
        agent_config = prompt_manager.load_json_config("researcher")
        ...
        self.searcher = SAGSearcher(
            prompt_manager=prompt_manager,  # 使用上面已创建的 prompt_manager
...
请制定详细的搜索计划。"""
    ...
    async def _execute_search(
        ...
        Args:
            ...
            keywords: 关键词列表
        """
        from dataflow.modules.search.config import RerankConfig
